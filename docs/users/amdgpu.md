...
Newer Bianbu versions have the kernel patches that allow AMD GPUs to work, so minimal configuration is necessary.

Refer to the official guide:

[https://www.spacemit.com/community/document/info?lang=en&nodepath=software/SDK/bianbu/development/amd.md](https://www.spacemit.com/community/document/info?lang=en&nodepath=software/SDK/bianbu/development/amd.md)

## Outdated guides, for reference
